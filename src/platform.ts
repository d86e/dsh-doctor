...
export async function writeServiceSpec(spec: ServiceSpec): Promise<void> {
...
export async function removeServiceSpec(): Promise<void> {
...
function plistBody(opts: { nodeBin: string; dshHome: string; webPort: number }): string {
...
function systemdBody(opts: { nodeBin: string; dshHome: string; webPort: number }): string {
  return `[Unit]
...
function windowsTaskXml(opts: { dshHome: string; webPort: number }): string {
...
function windowsVbsLauncher(opts: { nodeBin: string; dshHome: string; webPort: number }): string {
